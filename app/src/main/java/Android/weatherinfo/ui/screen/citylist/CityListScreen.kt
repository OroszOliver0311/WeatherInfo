...
import Android.weatherinfo.ui.common.StringInputDialog
import Android.weatherinfo.ui.screen.citylist.components.CityCard
                ...
                LazyColumn(
                    ...
                    items(items = state.cityList, key = { item -> item.id }) { city ->
                        CityCard(
                            ...
                            onDelete = { cityName ->
                                viewModel.onEvent(CityListScreenEvent.CityDeleted(cityName))
                            }
                        )
